...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('citekey', publications_bootstrap.fields.NullCharField(blank=True, db_index=True, help_text='BibTex citation key. Leave blank if unsure.', max_length=512, null=True, unique=True)),
                ...
                ('month', echoices.fields.EMonthsField(blank=True, db_index=True, echoices=publications_bootstrap.models.publication.EMonths, null=True)),
                ...
                ('external', models.BooleanField(db_index=True, default=False, help_text='If publication was written in another lab, mark as external.')),
                ...
                ('status', echoices.fields.EStatusesField(default=publications_bootstrap.models.publication.EStatuses('p'), echoices=publications_bootstrap.models.publication.EStatuses)),
            ],
            options={
